			...
			<div class="row pt-3">
				...
				<div class="col-md-4 mb-4">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="portfolioName"
											...
											rows="5" cols="5" maxlength=35
											value="<%=DataUtility.getStringData(dto.getPortfolioName())%>">

									</div>

									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("portfolioName", request)%></font>
								</div>
					...
					: DataUtility.getStringData(dto.getInitialInvestmentAmount())%>">
									...
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("initialInvestmentAmount", request)%></font>
								</div>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<textarea name="investmentStrategy"
											placeholder="Enter Investment Strategy" class="form-control"
											rows="5" cols="5" maxlength="250">
<%=DataUtility.getStringData(dto.getInvestmentStrategy())%>
        </textarea>
									</div>
									<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("investmentStrategy", request)%>
									</font>
								</div>
